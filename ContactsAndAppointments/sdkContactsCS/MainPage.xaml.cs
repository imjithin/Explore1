...
namespace sdkContactsCS
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private void SearchContacts_Click(object sender, RoutedEventArgs e)
        {
            ...
            cons.SearchAsync(contactFilterString.Text, FilterKind.DisplayName, "Contacts Test #1");
        }
        ...
        private void LaunchCalander()
        {
            SaveAppointmentTask sa = new SaveAppointmentTask();
            sa.Show();
